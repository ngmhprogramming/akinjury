...
'''nosebleed_crawler = GoogleImageCrawler(storage={'root_dir': 'injuries/nosebleed'})
...
contusion_crawler = GoogleImageCrawler(storage={'root_dir': 'injuries/contusion'})
...
burn_crawler = GoogleImageCrawler(storage={'root_dir': 'injuries/firstdegburn'})
...
'''cut_crawler = GoogleImageCrawler(storage={'root_dir': 'injuries/minorcut'})
cut_crawler.crawl(keyword='minor cut', max_num=100, min_size=(200,200))

snake_crawler = GoogleImageCrawler(storage={'root_dir': 'injuries/snakebite'})
